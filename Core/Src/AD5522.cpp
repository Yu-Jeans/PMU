...
AD5522::AD5522(
    ...
    : hspi(spi), syncPort(syncP), syncPin(syncN), busyPort(busyP), busyPin(busyN), resetPort(resetP), resetPin(resetN){}

float AD5522::GetRsenseValue(uint8_t range_bits) {
    switch(range_bits) {
        case RANGE_5uA: return 200000.0f;
        case RANGE_20uA: return 50000.0f;
        case RANGE_200uA: return 5000.0f;
        case RANGE_2mA: return 500.0f;
